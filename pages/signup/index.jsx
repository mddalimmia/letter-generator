    ...
    <div className={styles.container}>
      ...
      <div className={styles.wrapper}>
        ...
        <div className={styles.nameWrapper}>
          ...
          <div className={styles.department}>
            ...
            <select>
              ...
              <option value="optiona">Department A</option>
              <option value="optionb">Department B</option>
            </select>
          </div>
        </div>
        ...
        <div className={styles.passportNumber}>
          ...
          <input placeholder="Enter Your Passport Id" />
        </div>
        <div className={styles.passportCountry}>
